...
from .canonical_registry import get_priority_list, is_not_applicable
...
def resolve_item(
    ...
    *,
    ...
    if is_not_applicable(concept_id, sector_profile):
        return {
            'value': None,
            'tag': None,
            'context_id': None,
            ...
            'scale_applied': None,
            'confidence': 100,
            'selection_reason': f'not_applicable_for_sector:{sector_profile or "unknown"}',
            'priority_rank': -1,
            'parent_child_mismatch_pct': None,
            'candidates': [],
        }
    ordered_tags = get_priority_list(concept_id, sector_profile)
